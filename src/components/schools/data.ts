...
export const schoolData: SchoolData[] = [
  {
    ...
    description: "24 филиала в Тюмени. Самый большой автодром, который включает в себя 4 площадки. Только у нас закрытая обогреваемая площадка для прохождения обучения на категорию «А». Работаем Пн-Пт: 10:00-19:00.",
    category: "Премиум",
    image: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800&h=600&fit=crop",
    rating: 4.9,
    price: "12,500₽",
    experience: "Много лет",
    location: "Тюмень, 24 филиала",
    phone: "89044972862",
    instructor: "Опытные инструкторы",
    courses: ["Категория А", "Категория А1"],
    features: ["24 филиала в Тюмени", "Самый большой автодром", "Закрытая обогреваемая площадка", "Режим работы Пн-Пт: 10:00-19:00"],
