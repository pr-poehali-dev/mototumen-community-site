...
export const schoolData: SchoolData[] = [
  ...
  {
    id: 2,
    name: "АВТОШКОЛА ВЕКТОР",
    description: "Автошкола Вектор в Тюмени - это новейшие методики обучения вождению на надежных и качественных автомобилях. Просторные и комфортные аудитории, опытные инструкторы с многолетним стажем. Современный подход к обучению с использованием передовых технологий.",
    category: "Премиум",
