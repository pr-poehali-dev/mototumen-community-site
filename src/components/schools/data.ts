...
export const schoolData: SchoolData[] = [
  ...
  },
  {
    ...
    instructor: 
      {
        "Понедельник", "График работы:" "10:00–14:00, 14:30–19:00" 
        },
      {
        "Вторник", "График работы:" "10:00–14:00, 14:30–19:00" 
        },
      {
        "Среда", "График работы:" "10:00–14:00, 14:30–19:00" 
        },
      {
        "Четверг", "График работы:" "10:00–14:00, 14:30–19:00" 
        },
      {
        "Пятница", "График работы:" "10:00–14:00, 14:30–19:00" 
        },
      {
        "Суббота", "График работы:" "Выходной" 
        },
      {
        "Воскресенье", "График работы:" "Выходной" 
        }
